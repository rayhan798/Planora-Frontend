      ...
      <DialogContent className="max-w-2xl bg-white rounded-[3rem] p-8 md:p-12 overflow-y-auto max-h-[90vh] shadow-2xl border-none outline-none">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input {...register("title")} placeholder="e.g. Tech Carnival 2026" className="h-14 rounded-2xl bg-slate-50 border-slate-100 font-bold focus:bg-white transition-all outline-none" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <Input 
                ...
                {...register("date")} 
                className="h-14 rounded-2xl bg-slate-50 border-slate-100 font-bold outline-none" 
              />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <Select 
                ...
                onValueChange={(val) => setValue("isPublic", val === "public")}
              >
